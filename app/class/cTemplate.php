...
/**
 * La classe Template permet de garder le code HTML dans des fichiers externes
 * Ces fichiers sont totalement exempts de code PHP, mais contiennent des champs de remplacement.
 * La classe propose des fonctions qui peuvent remplir les champs de remplacement avec des chaînes
 * arbitraires. Ces chaînes peuvent devenir très volumineux, par exemple, des tables entières.
 * La classe Template a pour origine la librairie PhpLib
 *
 */
